...
注册用例位于 ``registration.application``；本模块只负责终端输入和批处理
编排，Web 管理服务不会依赖 CLI。
"""
import sys
import argparse
...
def run_registration(
    ...
    """Backward-compatible wrapper around the registration application use case."""
    from registration.application.use_case import run_registration as _run_registration

...
apply_env_overrides(globals(), {
    'USE_EMAIL_SERVICE': 'bool',
    'OTP_MAX_WAIT': 'int',
    'OTP_POLL_INTERVAL': 'int',
    'OTP_SETTLE_SECONDS': 'int',
    'EMAIL_SOURCE': 'str',
    'EMAIL_IMPORT_SEPARATORS': 'str',
    'OUTLOOK_API_BASE': 'str',
    'OUTLOOK_FETCH_MODE': 'str',
    'EMAIL_DOMAIN': 'str',
    'QQ_IMAP_SERVER': 'str',
    'QQ_IMAP_PORT': 'int',
    'QQ_EMAIL': 'str',
    'QQ_IMAP_PASSWORD': 'str',
    'GPTMAIL_API_KEY': 'str',

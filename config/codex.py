...
#   "chrome_cdp" = 正常启动本机 Chrome，再通过 CDP 接管（本地推荐）
...
# 本机 Chrome CDP 驱动。路径留空时自动查找系统 Google Chrome。
CHROME_CDP_EXECUTABLE_PATH: str = ""
CHROME_CDP_START_TIMEOUT: int = 20
CHROME_CDP_PAGE_TIMEOUT: int = 90
CHROME_CDP_KEEP_BROWSER_OPEN: bool = False
...
apply_env_overrides(globals(), {'ENABLE_CODEX_AUTO': 'bool', 'CODEX_OAUTH_DRIVER': 'str', 'CHROME_CDP_EXECUTABLE_PATH': 'str', 'CHROME_CDP_START_TIMEOUT': 'int', 'CHROME_CDP_PAGE_TIMEOUT': 'int', 'CHROME_CDP_KEEP_BROWSER_OPEN': 'bool', 'CODEX_AUTH_URL_SOURCE': 'str', 'CPA_MANAGEMENT_URL': 'str', 'CPA_MANAGEMENT_KEY': 'str', 'CPA_REQUEST_TIMEOUT': 'int', 'CPA_CALLBACK_SUBMIT_RETRIES': 'int', 'CPA_CALLBACK_SUBMIT_RETRY_DELAY': 'int', 'CPA_SAVE_CALLBACK_RECEIPT': 'bool', 'SMS_PROVIDER': 'str', 'SMS_COUNTRY': 'str', 'SMS_SERVICE': 'str', 'SMS_MAX_RETRIES': 'int', 'SMS_CODE_WAIT': 'int', 'SMS_API_KEY': 'str', 'FIXED_SMS_PHONE': 'str', 'FIXED_SMS_CODE_URL': 'str', 'H_API_BASE': 'str', 'H_ADMIN_AUTH_CODE': 'str', 'H_PHONE_PREFIX': 'str', 'H_PHONE_ACQUIRE_MODE': 'str', 'L_API_BASE': 'str', 'L_ADMIN_AUTH_CODE': 'str', 'L_PHONE_PREFIX': 'str'})
